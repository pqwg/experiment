...
#define SABER_POLYVECCOMPRESSEDBYTES (SABER_K * 288) // 288 = 9*256/8

#define SABER_CIPHERTEXTBYTES (SABER_POLYVECCOMPRESSEDBYTES + SABER_SCALEBYTES_KEM)
