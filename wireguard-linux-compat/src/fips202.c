...
void shake128_inc_ctx_release(shake128incctx *state) { (void)state->ctx; }
...
void shake256_inc_ctx_release(shake256incctx *state) { (void)state->ctx; }
...
void shake128_ctx_release(shake128ctx *state) { (void)state->ctx; }
...
/** Release the allocated state. Call only once. */
void shake256_ctx_release(shake256ctx *state) { (void)state->ctx; }
...
void sha3_256_inc_ctx_release(sha3_256incctx *state) { (void)state->ctx; }
...
void sha3_384_inc_ctx_release(sha3_384incctx *state) { (void)state->ctx; }
...
void sha3_512_inc_ctx_release(sha3_512incctx *state) { (void)state->ctx; }
